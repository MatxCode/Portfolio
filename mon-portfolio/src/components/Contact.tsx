          ...
          <div className={`transition-all duration-1000 delay-100 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'} text-left`}>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="text-left">
                  ...
                  <a href="https://www.votredomaine.com" className="text-gray-400 hover:text-purple-400">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/MatxCode" className="bg-gray-800 p-3 rounded-full hover:bg-purple-500/20 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/mateo-letertre/" className="bg-gray-800 p-3 rounded-full hover:bg-purple-500/20 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
