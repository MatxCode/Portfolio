      ...
      <div className="section-container text-center w-full max-w-4xl px-4">
        <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <div className="mt-12 flex justify-center space-x-6">
            <a href="https://github.com/MatxCode" aria-label="Github" className="text-gray-400 hover:text-white transition-colors" target="_blank">
            ...
            <a href="https://www.linkedin.com/in/mateo-letertre/" aria-label="LinkedIn" className="text-gray-400 hover:text-white transition-colors" target="_blank">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
